...
<div class="allcontent">
    ...
    <div class="maintitle">Layouts</div>
...
Display {{$layouts->count()}} Records Through {{$layouts->total()}} Records</span>
            <div class="bluebtn"><a href="{{adminurl('layouts/create')}}">+Add New Layout</a></div>
        ...
        <div id="gride-bg">
            <div class="tablegrid">
                ...
                <div class="tablegridrow">
                    ...
                    <div>
                        <a href="{{adminurl('layouts/edit/'.$layout->id)}}">Edit</a> | 
                        <a class="delete" prop="layout" href="{{  adminurl('layouts/delete/'.$layout->id) }} ">Delete</a></div>        
                </div>
                @endforeach   


            </div>
            <?php echo $layouts->render(); ?>
