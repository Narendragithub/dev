...
Display {{$categories->count()}} Records Through {{$categories->total()}} Records</span>
            <div class="bluebtn"><a href="{{adminurl('categories/create')}}">+Add New Category</a></div>
        ...
        <div id="gride-bg">
            <div class="tablegrid">
                ...
                <div class="tablegridrow">
                    ...
                    <div>{{ $category->projects->count() }} </div>
                    <div>@if($category->parentcategory) {{ $category->parentcategory->category }} @else Main Category @endif</div>   
                    <div>
                        <a href="{{adminurl('categories/edit/'.$category->id)}}">Edit</a> | 
                        <a class="delete"  prop="category"  href="{{  adminurl('categories/delete/'.$category->id) }} ">Delete</a></div>        
