<div role="tabpanel" class="tab-pane  animated fadeInRight" id="prdetails">
    ...
    <form class="form-horizontal store" name="editproject" id="editproject" method="POST" action="<?php echo url('project/savedetails')?>" enctype="multipart/form-data">
        <?php echo csrf_field();?>
        <div class="card-body card-padding">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="fg-line">
                        <textarea class="form-control" rows="5" name="description" placeholder="Full description"><?php echo $project->short_description?></textarea>
                    </div>
                </div>
            </div>
            <div class="form-group">
